          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            ...
            <div className="lg:col-span-7">
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
                <div className="bg-white border border-natural-border p-6 rounded-2xl shadow-xs space-y-2 hover:border-brand-200 transition-colors">
                  <span className="text-2xl">🗑️</span>
                  <h4 className="font-bold text-[10px] uppercase tracking-wider text-natural-text">1/3 of All Food</h4>
                ...
                <div className="bg-white border border-natural-border p-6 rounded-2xl shadow-xs space-y-2 hover:border-brand-200 transition-colors">
                  ...
                  <h4 className="font-bold text-[10px] uppercase tracking-wider text-natural-text">Safe Consumption</h4>
                  <p className="text-[11px] text-natural-muted leading-relaxed font-semibold">
                ...
                <div className="bg-white border border-natural-border p-6 rounded-2xl shadow-xs space-y-2 hover:border-brand-200 transition-colors">
                  <span className="text-2xl">🚴</span>
                  <h4 className="font-bold text-[10px] uppercase tracking-wider text-natural-text">Detour Efficiency</h4>
                  <p className="text-[11px] text-natural-muted leading-relaxed font-semibold">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div className="bg-[#FAF9F5] border border-natural-border p-6 rounded-2xl shadow-sm text-left flex flex-col justify-between hover:border-brand-200 transition-colors">
              <div className="space-y-3">
                ...
                <h4 className="font-bold text-xs uppercase tracking-wider text-natural-text">Food should not go to waste</h4>
                <p className="text-[11px] text-natural-muted leading-relaxed font-semibold">
            ...
            <div className="bg-[#FAF9F5] border border-natural-border p-6 rounded-2xl shadow-sm text-left flex flex-col justify-between hover:border-brand-200 transition-colors">
              <div className="space-y-3">
                <span className="text-xl">🚀</span>
                <h4 className="font-bold text-xs uppercase tracking-wider text-natural-text">Technology should solve real problems</h4>
                <p className="text-[11px] text-natural-muted leading-relaxed font-semibold">
            ...
            <div className="bg-[#FAF9F5] border border-natural-border p-6 rounded-2xl shadow-sm text-left flex flex-col justify-between hover:border-brand-200 transition-colors">
              <div className="space-y-3">
                <span className="text-xl">🤝</span>
                <h4 className="font-bold text-xs uppercase tracking-wider text-natural-text">Every delivery should be trustworthy</h4>
                <p className="text-[11px] text-natural-muted leading-relaxed font-semibold">
            ...
            <div className="bg-[#FAF9F5] border border-natural-border p-6 rounded-2xl shadow-sm text-left flex flex-col justify-between hover:border-brand-200 transition-colors">
              <div className="space-y-3">
                <span className="text-xl">🌱</span>
                <h4 className="font-bold text-xs uppercase tracking-wider text-natural-text">Small actions can create measurable impact</h4>
                <p className="text-[11px] text-natural-muted leading-relaxed font-semibold">
